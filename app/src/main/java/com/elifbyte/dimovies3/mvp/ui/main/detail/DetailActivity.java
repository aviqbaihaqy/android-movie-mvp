...
public class DetailActivity extends BaseActivity implements DetailMvpView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter.checkIfExist((long) movie.getId());

        Log.d("detailActivity", String.valueOf(movie.getId()));
...
//                Favorite favorite = getIntent().getParcelableExtra(EXTRA_MOVIE);
                ...
                favorite.setId((long) movie.getId());
                ...
                if (fabFavorite.isSelected()) {
                    mPresenter.removeFavoriteMovie(favorite);
                } else {
                    mPresenter.setFavoriteMovie(favorite);
                }
    ...
    @Override
    public void updateFabFavorite(Boolean selected) {
        fabFavorite.setSelected(selected);

        if (fabFavorite.isSelected()) {
            fabFavorite.setImageResource(R.drawable.ic_favorite);
            fabFavorite.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.white)));
        } else {
            fabFavorite.setImageResource(R.drawable.ic_favorite_outline_white);
            fabFavorite.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.colorAccent)));
        }
    }
