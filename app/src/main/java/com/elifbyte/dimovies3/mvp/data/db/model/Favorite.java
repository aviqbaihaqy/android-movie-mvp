...
package com.elifbyte.dimovies3.mvp.data.db.model;
...
public class Favorite implements Parcelable {
    ...
    @Generated(hash = 800314584)
    public Favorite(Long id, String overview, String originalLanguage, String originalTitle, boolean video, String title, String posterPath, String backdropPath, String releaseDate, double voteAverage, double popularity, boolean adult, int voteCount) {
        this.id = id;
