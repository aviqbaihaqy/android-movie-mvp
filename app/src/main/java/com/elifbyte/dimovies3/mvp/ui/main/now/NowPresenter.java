...
package com.elifbyte.dimovies3.mvp.ui.main.now;
...
public class NowPresenter<V extends NowMvpView> extends BasePresenter<V>
        implements NowMvpPresenter<V> {

    @Inject
    public NowPresenter(DataManager dataManager,
