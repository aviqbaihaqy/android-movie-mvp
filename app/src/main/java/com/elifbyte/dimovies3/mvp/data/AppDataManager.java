...
package com.elifbyte.dimovies3.mvp.data;
...
public class AppDataManager implements DataManager {
    ...
    @Override
    public Observable<Boolean> deleteFavorite(Favorite favorite) {
        return mDbHelper.deleteFavorite(favorite);
    }
    ...
    @Override
    public Observable<Favorite> getFavoriteById(Long id) {
        return mDbHelper.getFavoriteById(id);
    }
