...
package com.elifbyte.dimovies.mvp.ui.base;
...
public class BasePresenter<V extends MvpView> implements MvpPresenter<V> {
    ...
    public void handleApiError(ANError error) {
        ...
        if (error == null || error.getErrorBody() == null) {
            getMvpView().onError(com.elifbyte.dimovies.mvp.R.string.api_default_error);
            return;
        }

        if (error.getErrorCode() == AppConstants.API_STATUS_CODE_LOCAL_ERROR
                && error.getErrorDetail().equals(ANConstants.CONNECTION_ERROR)) {
            getMvpView().onError(com.elifbyte.dimovies.mvp.R.string.connection_error);
            return;
        }

        if (error.getErrorCode() == AppConstants.API_STATUS_CODE_LOCAL_ERROR
                && error.getErrorDetail().equals(ANConstants.REQUEST_CANCELLED_ERROR)) {
            getMvpView().onError(com.elifbyte.dimovies.mvp.R.string.api_retry_error);
            return;
        }
